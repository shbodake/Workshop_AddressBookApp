...
public class PersonController {
	...
	/**
	 * To call post method to add person details in DB
	 * @param PersonDTO
	...
	public ResponseEntity<ResponseDTO> createAddressBookData(@RequestParam int addressbookId, @Valid
		...
		contactDetails = personService.createPersonData(addressbookId, personDTO);
		ResponseDTO respDTO = new ResponseDTO("created address book data successfully", contactDetails);
		return new ResponseEntity<ResponseDTO>(respDTO, HttpStatus.OK);
	}

	/**
	 * To call post method to update person detail by id
	...
	/**
	 * To call get method to get all person list from DB
	 * 
	 * @return : ResponseDTO
	 */
	...
	/**
	 * To call get method to get person details by id
	 * @param id
	 * @return : ResponseDTO
	 */
	@GetMapping("/get")
	...
	/**
	 * To call delete method to remove person details by id
	 * @param : contactId
	 * @return : ResponseDTO
	 */
